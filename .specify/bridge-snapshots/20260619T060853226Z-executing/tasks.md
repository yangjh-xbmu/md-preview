...
- [ ] T002 Verify the current Wails icon assets exist at `build/appicon.png` and `build/windows/icon.ico`
...
- [ ] T004 [US1] Convert `D:/Users/yangjh/Desktop/Inbox/md-preview-app-icon-final-left-layout.svg` into `build/appicon.png` and a multi-size Windows icon at `build/windows/icon.ico`
- [ ] T005 [US1] Inspect `build/appicon.png` and `build/windows/icon.ico` to confirm they are valid icon assets
